...
export const MODULOS = [
  ...
  },
  {
    ...
    estado: 'pendiente',
    resumen: 'Replanteamiento de instrumentos tradicionales. Evaluación formativa continua y sumativa. Rúbricas analíticas para retroalimentación específica.\n\nLa evaluación en entornos virtuales no puede limitarse a la réplica de exámenes presenciales. Se exploran herramientas como portafolios digitales, rúbricas analíticas, coevaluación y autoevaluación. También se abordan los desafíos de integridad académica y el diseño de experiencias evaluativas auténticas.',
    temas: ['Evaluación formativa', 'Rúbricas', 'Integridad académica', 'Retroalimentación', 'Portafolios digitales'],
    recursos: [
      { tipo: 'video', label: 'Evaluación auténtica en línea', url: 'https://www.youtube.com/embed/dQw4w9WgXcQ' },
  ...
  },
  {
    ...
    estado: 'pendiente',
    resumen: 'Construcción de comunidad como factor clave. Estrategias de moderación y trabajo colaborativo asincrónico. Lineamientos del TFI: diseño completo de curso de 4 semanas.\n\nEl módulo final integra todos los aprendizajes del taller. Se aborda el diseño de comunidad virtual siguiendo el modelo de Gilly Salmon (e-tivities y e-moderating), el rol del docente como moderador y facilitador, y se presentan en detalle los requisitos del Trabajo Final Integrador.',
    temas: ['Moderación de foros', 'Trabajo colaborativo', 'Rol del tutor', 'TFI', 'Comunidad virtual'],
    recursos: [
      { tipo: 'video', label: 'Gilly Salmon — E-tivities en acción', url: 'https://www.youtube.com/embed/dQw4w9WgXcQ' },
      { tipo: 'video', label: 'Cómo construir comunidad virtual educativa', url: 'https://www.youtube.com/embed/dQw4w9WgXcQ' },
      { tipo: 'pdf', label: 'Salmon - E-tivities', url: '#' },
      { tipo: 'link', label: 'Guía TFI — documento completo', url: '#' },
    ],
  },
]
